...
comment on column public.practice_test_blueprints.allow_pause is
  'Copied into each new practice session; the Mitchell 50-question blueprint permits a server-authoritative pause.';
