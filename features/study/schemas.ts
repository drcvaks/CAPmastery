...
const sessionQuestionRowSchema = z.object({
  ...
  question_id: z.uuid(),
  chapter_number: z.number().int().positive().nullable().default(null),
  chapter_title: z.string().min(1).nullable().default(null),
  topic_title: z.string().min(1).nullable().default(null),
